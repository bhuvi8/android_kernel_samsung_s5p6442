...
#define S5P6442_GPIO_MP01_NR	(8)
#define S5P6442_GPIO_MP02_NR	(4)
#define S5P6442_GPIO_MP03_NR	(5)
#define S5P6442_GPIO_MP04_NR	(8)
#define S5P6442_GPIO_MP05_NR	(8)
#define S5P6442_GPIO_MP06_NR	(8)
#define S5P6442_GPIO_MP07_NR	(8)
#define S5P6442_GPIO_MP10_NR	(8)
#define S5P6442_GPIO_MP11_NR	(8)
#define S5P6442_GPIO_MP12_NR	(8)
#define S5P6442_GPIO_MP13_NR	(8)
#define S5P6442_GPIO_MP14_NR	(8)
#define S5P6442_GPIO_MP15_NR	(8)
#define S5P6442_GPIO_MP16_NR	(8)
#define S5P6442_GPIO_MP17_NR	(8)
#define S5P6442_GPIO_MP18_NR	(7)
...
enum s5p_gpio_number {
	...
	S5P6442_GPIO_MP01_START	= S5P6442_GPIO_NEXT(S5P6442_GPIO_J4),
	S5P6442_GPIO_MP02_START	= S5P6442_GPIO_NEXT(S5P6442_GPIO_MP01),
	S5P6442_GPIO_MP03_START	= S5P6442_GPIO_NEXT(S5P6442_GPIO_MP02),
	S5P6442_GPIO_MP04_START	= S5P6442_GPIO_NEXT(S5P6442_GPIO_MP03),
	S5P6442_GPIO_MP05_START	= S5P6442_GPIO_NEXT(S5P6442_GPIO_MP04),
	S5P6442_GPIO_MP06_START	= S5P6442_GPIO_NEXT(S5P6442_GPIO_MP05),
	S5P6442_GPIO_MP07_START	= S5P6442_GPIO_NEXT(S5P6442_GPIO_MP06),
	S5P6442_GPIO_MP10_START	= S5P6442_GPIO_NEXT(S5P6442_GPIO_MP07),
	S5P6442_GPIO_MP11_START	= S5P6442_GPIO_NEXT(S5P6442_GPIO_MP10),
	S5P6442_GPIO_MP12_START	= S5P6442_GPIO_NEXT(S5P6442_GPIO_MP11),
	S5P6442_GPIO_MP13_START	= S5P6442_GPIO_NEXT(S5P6442_GPIO_MP12),
	S5P6442_GPIO_MP14_START	= S5P6442_GPIO_NEXT(S5P6442_GPIO_MP13),
	S5P6442_GPIO_MP15_START	= S5P6442_GPIO_NEXT(S5P6442_GPIO_MP14),
	S5P6442_GPIO_MP16_START	= S5P6442_GPIO_NEXT(S5P6442_GPIO_MP15),
	S5P6442_GPIO_MP17_START	= S5P6442_GPIO_NEXT(S5P6442_GPIO_MP16),
	S5P6442_GPIO_MP18_START	= S5P6442_GPIO_NEXT(S5P6442_GPIO_MP17),	
};
...
#define S5P6442_MP01(_nr)	(S5P6442_GPIO_MP01_START + (_nr))
#define S5P6442_MP02(_nr)	(S5P6442_GPIO_MP02_START + (_nr))
#define S5P6442_MP03(_nr)	(S5P6442_GPIO_MP03_START + (_nr))
#define S5P6442_MP04(_nr)	(S5P6442_GPIO_MP04_START + (_nr))
#define S5P6442_MP05(_nr)	(S5P6442_GPIO_MP05_START + (_nr))
#define S5P6442_MP06(_nr)	(S5P6442_GPIO_MP06_START + (_nr))
#define S5P6442_MP07(_nr)	(S5P6442_GPIO_MP07_START + (_nr))
#define S5P6442_MP10(_nr)	(S5P6442_GPIO_MP10_START + (_nr))
#define S5P6442_MP11(_nr)	(S5P6442_GPIO_MP11_START + (_nr))
#define S5P6442_MP12(_nr)	(S5P6442_GPIO_MP12_START + (_nr))
#define S5P6442_MP13(_nr)	(S5P6442_GPIO_MP13_START + (_nr))
#define S5P6442_MP14(_nr)	(S5P6442_GPIO_MP14_START + (_nr))
#define S5P6442_MP15(_nr)	(S5P6442_GPIO_MP15_START + (_nr))
#define S5P6442_MP16(_nr)	(S5P6442_GPIO_MP16_START + (_nr))
#define S5P6442_MP17(_nr)	(S5P6442_GPIO_MP17_START + (_nr))
#define S5P6442_MP18(_nr)	(S5P6442_GPIO_MP18_START + (_nr))

/* the end of the S5P6442 specific gpios */
#define S5P6442_GPIO_END	(S5P6442_MP18(S5P6442_GPIO_MP18_NR) + 1)
#define S3C_GPIO_END		S5P6442_GPIO_END

/* define the number of gpios we need to the one after the S5P6442_GPJ4() range */
#define ARCH_NR_GPIO		(S5P6442_MP18(S5P6442_GPIO_MP18_NR) + 1)
